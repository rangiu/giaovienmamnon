...
export default function AssessmentReportsPage() {
  ...
  useEffect(() => {
    // Lấy TẤT CẢ báo cáo của TẤT CẢ học sinh trong lớp — trước đây chỉ lấy
    // báo cáo của đúng 1 học sinh đầu tiên trong lớp là bug.
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
                <div className="space-y-1">
                  ...
                  <h3 className="font-extrabold text-slate-900 text-base">
                    Báo cáo Đánh giá Phát triển — {report.student?.name || "Học sinh"} ({report.period?.name || "Chưa có kỳ đánh giá"})
                  </h3>
                </div>
