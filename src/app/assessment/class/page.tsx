        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Kỳ đánh giá: <span className="font-bold text-emerald-800">{classInfo?.periodName || "Tháng 8/2026"}</span> • Sĩ số: <span className="font-bold text-slate-800">{classInfo?.studentCount || 28} học sinh</span>
            </p>
          </div>
        </div>
