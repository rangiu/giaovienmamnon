      ...
      printContainer.innerHTML = `
        <div style="border-bottom: 2px solid #059669; padding-bottom: 8px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: flex-end;">
          ...
          <div style="text-align: right; font-size: 11px; color: #475569;">
            ...
            <p style="margin: 2px 0 0 0;"><b>Lớp:</b> ${topicData.topicInfo.className} (${topicData.topicInfo.ageGroup}) • <b>Giáo viên:</b> Cô Lan</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              {topics.length > 1 && (
                <select
                  ...
                  className="text-xs font-bold bg-slate-50 border border-slate-200 rounded-lg px-2 py-0.5 text-slate-700"
                >
                  {topics.map((t) => (
            ...
            <p className="text-xs text-slate-500 mt-1">
              ...
              <strong className="text-emerald-800">Cô Lan</strong>
            </p>
          </div>
        </div>
