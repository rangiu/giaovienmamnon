      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 p-6 md:p-8 text-white shadow-xl shadow-emerald-200">
        <div className="relative z-10 space-y-4 max-w-2xl">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight">
            Xin chào {teacher?.user?.name || "Cô giáo"} 👋
          </h1>
          <p className="text-emerald-100 text-sm md:text-base leading-relaxed">
            Hôm nay cô cần em hỗ trợ gì? Nhập bất kỳ yêu cầu nào bằng câu nói tự nhiên, SUMFLOW sẽ giúp cô hoàn thành nhanh chóng.
          </p>

          <Link
            href="/chat"
            className="inline-flex items-center gap-2 bg-white hover:bg-emerald-50 text-emerald-700 text-sm font-bold px-5 py-2.5 rounded-xl shadow-sm transition-colors"
          >
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 line-clamp-1 mt-0.5">
                Soạn giáo án, tạo trò chơi & hỏi đáp
              </p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                {teacher?.className || "Lớp của tôi"} • {teacher?.schoolName || "Chưa cập nhật trường"}
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          ...
          <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200/60 col-span-2 sm:col-span-2">
            ...
            <strong className="text-emerald-800 text-sm font-black">
              {teacher?.currentTopic || "Chưa đặt chủ đề"}
            </strong>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        {recentLessons.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl p-8 text-center border border-dashed border-slate-300 space-y-3">
            ...
            <p className="text-xs text-slate-500">
              Cô chưa có giáo án nào gần đây. Hãy mở khung chat SUMFLOW để khởi tạo giáo án đầu tiên nhé!
            </p>
            <Link
              href="/chat"
